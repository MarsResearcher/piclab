        ...
        <header className="lite-home-header glass">
          ...
          <div className="lite-home-actions">
            <a
              ...
              title="在 GitHub 查看源码"
            >
              <svg className="lite-home-github-icon" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fill="currentColor"
                  d="M12 2C6.477 2 2 6.586 2 12.253c0 4.537 2.865 8.383 6.839 9.743.5.094.683-.222.683-.492 0-.243-.01-1.046-.014-1.9-2.782.62-3.37-1.37-3.37-1.37-.454-1.182-1.11-1.496-1.11-1.496-.908-.638.069-.625.069-.625 1.004.072 1.532 1.057 1.532 1.057.892 1.568 2.341 1.115 2.91.853.091-.664.35-1.115.636-1.372-2.22-.259-4.555-1.14-4.555-5.073 0-1.12.39-2.037 1.03-2.756-.103-.26-.447-1.302.098-2.714 0 0 .84-.276 2.75 1.052A9.34 9.34 0 0 1 12 6.996c.85.004 1.705.118 2.504.346 1.909-1.328 2.747-1.052 2.747-1.052.547 1.412.203 2.454.1 2.714.64.719 1.028 1.636 1.028 2.756 0 3.944-2.338 4.811-4.566 5.065.359.317.679.944.679 1.904 0 1.374-.012 2.482-.012 2.82 0 .273.18.592.688.491C19.138 20.632 22 16.787 22 12.253 22 6.586 17.523 2 12 2z"
                />
              </svg>
              <span>GitHub</span>
            </a>
